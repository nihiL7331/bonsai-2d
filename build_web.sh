...
sokol-shdc/$SHDC_PLATFORM$SHDC_ARCH/sokol-shdc -i source/shader.glsl -o source/shader.odin -l glsl430:metal_macos:hlsl5:glsl300es -f sokol_odin
...
flags="-sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sALLOW_MEMORY_GROWTH -sINITIAL_MEMORY=67108864 -sMAX_WEBGL_VERSION=2 -sASSERTIONS --shell-file source/web/index_template.html --preload-file assets"
