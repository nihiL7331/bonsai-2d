...
flags="-sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sALLOW_MEMORY_GROWTH -sINITIAL_MEMORY=67108864 -sMAX_WEBGL_VERSION=2 -sASSERTIONS --shell-file source/core/platform/web/index.html --preload-file assets/images/atlas.png --preload-file assets/fonts"
