...
// Handles aspect ratio scaling to ensure the UI fits within the design resolution ([`GAME_WIDTH`](#game_width)/[`GAME_HEIGHT`](#game_height)).
...
// current viewport in **Screen Space**. Uses [`ScaleMode`](#scalemode) internally in its calculations.
